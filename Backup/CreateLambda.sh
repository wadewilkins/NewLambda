#!/bin/sh
cd Function; zip -r check_rds_mysql_alarms_and_send_to_emf.tar *; cd ..
cp -f Function/*.zip ./
lambda_name="check_rds_mysql_alarms_and_send_to_emf"
...
aws events put-targets \
    ...
    --targets '{"Id" : "1", "Arn": "arn:aws:lambda:us-west-2:129801715103:function:check_rds_mysql_alarms_and_send_to_emf"}'
